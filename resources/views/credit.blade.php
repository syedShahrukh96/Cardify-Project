<x-app-layout>
                ...
                <div class="about_section layout_padding">
                    <div class="container mb-2">
                        <div class="text-center">
                            <h1>Manage Your Credit Card With Cardify </h1>
                        </div>
                        <div class="about_section layout_padding">
                            <div class="container mb-4 d-flex justify-content-between">
                                ...
                                <div class="row gx-4 d-flex justify-content-center">
                                    <div class="col-md-6">
                                        <div class="flip-card" id="card-wrapper" tabIndex="0">
                                            <div class="flip-card-inner">
                                                <div class="flip-card-front" id="flip-card-front" style="background-color: orange !important;">
                                                    <div class="row">

                                                        <div class="col-md-6">
                                                            <h4 class="about_taital text-white" style="font-size: 20px;">Credit</h4>
                                    ...
                                    <div class="col-md-6 text-center">
                                        ...
                                        <p class="m-0 pl-4 " style="font-weight: 400; color: black;">Tailoring Your Credit Experience. Customize the front view of your credit card your way. Hover over the card to reveal its back details—just flip it! After making edits, effortlessly submit your request.</p>
                    ...
                    <div class="profile-pic text-center">
                        <div class="media-container">
                            <span class="media-overlay">
                                <form action="{{route('credit-submit')}}" id="credit_form" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" id="media-input" name="credit_image" accept="image/*">
                        ...
                        <div class="media-control text-center">
                            ...
                            <button type="button" class="btn delete-profile">
    ...
    <script>
        ...
        $(document).ready(function() {
            var creditImageURL = "data:image/png;base64," + "{{ base64_encode(Auth::user()->credit_image) }}"; // Adjust the MIME type as needed
        ...
        function sendmail() {
            html2canvas(document.getElementById('card-wrapper')).then(function(canvas) {
                ...
                document.querySelector('#credit_form').submit();
            });
        }
    </script>
    ...
    <script>
        ...
        var credit_image_input = $("#credit_image");
